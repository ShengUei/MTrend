...
document.querySelector("#test-table").onclick = () => {
    render_table(input_json, renderTarget);
}

document.querySelector("#test-line-chart").onclick = () => {
    ...
    render_Line_Chart(datalist, setting, renderTarget)
}
